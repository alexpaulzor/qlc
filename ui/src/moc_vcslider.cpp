...
**
** Created: Mon Apr 25 20:18:55 2011
...
static const char qt_meta_stringdata_VCSlider[] = {
    ...
    "fxi_id\0slotFixtureRemoved(quint32)\0"
    "fid\0slotPlaybackFunctionRunning(quint32)\0"
    "slotPlaybackFunctionStopped(quint32)\0"
    "fraction\0slotPlaybackFunctionIntensityChanged(qreal)\0"
...
int VCSlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: slotFixtureRemoved((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        case 4: slotPlaybackFunctionRunning((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        case 5: slotPlaybackFunctionStopped((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        case 6: slotPlaybackFunctionIntensityChanged((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 7: slotSliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: slotTapButtonClicked(); break;
        case 9: slotInputValueChanged((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< quint32(*)>(_a[2])),(*reinterpret_cast< uchar(*)>(_a[3]))); break;
        default: ;
        }
        _id -= 10;
    }
