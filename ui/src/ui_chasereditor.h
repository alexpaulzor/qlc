...
public:
    ...
    void setupUi(QDialog *ChaserEditor)
    {
        ...
        m_list = new QTreeWidget(ChaserEditor);
        m_list->setObjectName(QString::fromUtf8("m_list"));
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(1);
        sizePolicy2.setHeightForWidth(m_list->sizePolicy().hasHeightForWidth());
        m_list->setSizePolicy(sizePolicy2);
        m_list->setSelectionMode(QAbstractItemView::ExtendedSelection);
        m_list->setRootIsDecorated(false);
        m_list->setItemsExpandable(false);
        m_list->setAllColumnsShowFocus(true);

        gridLayout->addWidget(m_list, 1, 0, 10, 3);
        ...
        gridLayout->addWidget(m_raise, 4, 3, 1, 1);
        ...
        gridLayout->addWidget(m_lower, 5, 3, 1, 1);

        spacerItem = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(spacerItem, 10, 3, 1, 1);
        ...
        gridLayout->addWidget(groupBox_2, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(groupBox_3, 11, 2, 1, 2);
        ...
        gridLayout->addWidget(m_buttonBox, 12, 0, 1, 4);

        m_cutButton = new QToolButton(ChaserEditor);
        ...
        gridLayout->addWidget(m_cutButton, 7, 3, 1, 1);

        m_copyButton = new QToolButton(ChaserEditor);
        ...
        gridLayout->addWidget(m_copyButton, 8, 3, 1, 1);

        m_pasteButton = new QToolButton(ChaserEditor);
        ...
        gridLayout->addWidget(m_pasteButton, 9, 3, 1, 1);

        line = new QFrame(ChaserEditor);
        line->setObjectName(QString::fromUtf8("line"));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);

        gridLayout->addWidget(line, 3, 3, 1, 1);

        line_2 = new QFrame(ChaserEditor);
        line_2->setObjectName(QString::fromUtf8("line_2"));
        line_2->setFrameShape(QFrame::HLine);
        line_2->setFrameShadow(QFrame::Sunken);

        gridLayout->addWidget(line_2, 6, 3, 1, 1);
