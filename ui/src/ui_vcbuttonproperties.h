...
public:
    ...
    void setupUi(QDialog *VCButtonProperties)
    {
        ...
        VCButtonProperties->resize(396, 544);
        ...
        m_intensityGroup = new QGroupBox(VCButtonProperties);
        m_intensityGroup->setObjectName(QString::fromUtf8("m_intensityGroup"));
        m_intensityGroup->setCheckable(true);
        horizontalLayout = new QHBoxLayout(m_intensityGroup);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        m_intensitySlider = new QSlider(m_intensityGroup);
        m_intensitySlider->setObjectName(QString::fromUtf8("m_intensitySlider"));
        QSizePolicy sizePolicy1(QSizePolicy::MinimumExpanding, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(1);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(m_intensitySlider->sizePolicy().hasHeightForWidth());
        m_intensitySlider->setSizePolicy(sizePolicy1);
        m_intensitySlider->setMinimum(0);
        m_intensitySlider->setMaximum(100);
        m_intensitySlider->setOrientation(Qt::Horizontal);
        m_intensitySlider->setInvertedAppearance(false);
        m_intensitySlider->setInvertedControls(false);
        m_intensitySlider->setTickPosition(QSlider::TicksAbove);
        m_intensitySlider->setTickInterval(10);

        horizontalLayout->addWidget(m_intensitySlider);

        m_intensityEdit = new QLineEdit(m_intensityGroup);
        m_intensityEdit->setObjectName(QString::fromUtf8("m_intensityEdit"));
        QSizePolicy sizePolicy2(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(m_intensityEdit->sizePolicy().hasHeightForWidth());
        m_intensityEdit->setSizePolicy(sizePolicy2);
        m_intensityEdit->setMaximumSize(QSize(50, 16777215));
        m_intensityEdit->setMaxLength(4);

        horizontalLayout->addWidget(m_intensityEdit);


        verticalLayout->addWidget(m_intensityGroup);
...
#ifndef QT_NO_TOOLTIP
        m_intensityGroup->setToolTip(QApplication::translate("VCButtonProperties", "Adjust function intensity when it is running", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        m_intensityGroup->setTitle(QApplication::translate("VCButtonProperties", "Adjust Function Intensity", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        m_intensitySlider->setToolTip(QApplication::translate("VCButtonProperties", "Function's adjusted intensity percentage when run", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
