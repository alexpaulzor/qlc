...
**
** Created: Mon Apr 25 20:18:47 2011
...
static const char qt_meta_stringdata_VCButtonProperties[] = {
    ...
    "fid\0slotSetFunction(quint32)\0"
    ...
    "slotChooseInputClicked()\0value\0"
    "slotIntensitySliderMoved(int)\0text\0"
    "slotIntensityEdited(QString)\0accept()\0"
};
...
int VCButtonProperties::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: slotSetFunction((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        ...
        case 8: slotIntensitySliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 9: slotIntensityEdited((*reinterpret_cast< const QString(*)>(_a[1]))); break;
