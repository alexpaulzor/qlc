...
public:
    ...
    QSpacerItem *m_levelSpacer;
    QPushButton *m_switchToLevelModeButton;
    QWidget *Playback;
    QVBoxLayout *verticalLayout;
    QGroupBox *m_playbackFunctionGroup;
    QHBoxLayout *horizontalLayout;
    QLineEdit *m_playbackFunctionEdit;
    QToolButton *m_attachPlaybackFunctionButton;
    QToolButton *m_detachPlaybackFunctionButton;
    QSpacerItem *m_playbackSpacer;
    QPushButton *m_switchToPlaybackModeButton;
    ...
    void setupUi(QDialog *VCSliderProperties)
    {
        ...
        m_busSpacer = new QSpacerItem(418, 0, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalLayout_2 = new QVBoxLayout(Level);
        ...
        verticalLayout_2->addWidget(m_levelValueRangeGroup);
        ...
        verticalLayout_2->addWidget(m_levelList);
        ...
        m_levelSpacer = new QSpacerItem(20, 0, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_2->addItem(m_levelSpacer);
        ...
        verticalLayout_2->addWidget(m_switchToLevelModeButton);

        tabWidget->addTab(Level, QString());
        Playback = new QWidget();
        Playback->setObjectName(QString::fromUtf8("Playback"));
        verticalLayout = new QVBoxLayout(Playback);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        m_playbackFunctionGroup = new QGroupBox(Playback);
        m_playbackFunctionGroup->setObjectName(QString::fromUtf8("m_playbackFunctionGroup"));
        horizontalLayout = new QHBoxLayout(m_playbackFunctionGroup);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        m_playbackFunctionEdit = new QLineEdit(m_playbackFunctionGroup);
        m_playbackFunctionEdit->setObjectName(QString::fromUtf8("m_playbackFunctionEdit"));
        m_playbackFunctionEdit->setReadOnly(true);

        horizontalLayout->addWidget(m_playbackFunctionEdit);

        m_attachPlaybackFunctionButton = new QToolButton(m_playbackFunctionGroup);
        m_attachPlaybackFunctionButton->setObjectName(QString::fromUtf8("m_attachPlaybackFunctionButton"));
        m_attachPlaybackFunctionButton->setText(QString::fromUtf8("..."));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/attach.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_attachPlaybackFunctionButton->setIcon(icon);
        m_attachPlaybackFunctionButton->setIconSize(QSize(26, 26));

        horizontalLayout->addWidget(m_attachPlaybackFunctionButton);

        m_detachPlaybackFunctionButton = new QToolButton(m_playbackFunctionGroup);
        m_detachPlaybackFunctionButton->setObjectName(QString::fromUtf8("m_detachPlaybackFunctionButton"));
        m_detachPlaybackFunctionButton->setText(QString::fromUtf8("..."));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/detach.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_detachPlaybackFunctionButton->setIcon(icon1);
        m_detachPlaybackFunctionButton->setIconSize(QSize(26, 26));

        horizontalLayout->addWidget(m_detachPlaybackFunctionButton);


        verticalLayout->addWidget(m_playbackFunctionGroup);

        m_playbackSpacer = new QSpacerItem(20, 0, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout->addItem(m_playbackSpacer);

        m_switchToPlaybackModeButton = new QPushButton(Playback);
        m_switchToPlaybackModeButton->setObjectName(QString::fromUtf8("m_switchToPlaybackModeButton"));

        verticalLayout->addWidget(m_switchToPlaybackModeButton);

        tabWidget->addTab(Playback, QString());
    ...
    void retranslateUi(QDialog *VCSliderProperties)
    {
        ...
        m_playbackFunctionGroup->setTitle(QApplication::translate("VCSliderProperties", "Function", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        m_playbackFunctionEdit->setToolTip(QApplication::translate("VCSliderProperties", "Function that is attached to the slider", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        m_attachPlaybackFunctionButton->setToolTip(QApplication::translate("VCSliderProperties", "Attach a function to the slider", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        m_detachPlaybackFunctionButton->setToolTip(QApplication::translate("VCSliderProperties", "Detach the current function from the slider", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        m_switchToPlaybackModeButton->setToolTip(QApplication::translate("VCSliderProperties", "Make the slider control a function", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        m_switchToPlaybackModeButton->setText(QApplication::translate("VCSliderProperties", "Switch to Playback Mode", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(Playback), QApplication::translate("VCSliderProperties", "Playback", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
