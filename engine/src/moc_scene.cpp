...
**
** Created: Mon Apr 25 20:15:28 2011
...
static const char qt_meta_stringdata_Scene[] = {
    "Scene\0\0fxi_id\0slotFixtureRemoved(quint32)\0"
};

const QMetaObject Scene::staticMetaObject = {
    { &Function::staticMetaObject, qt_meta_stringdata_Scene,
...
void *Scene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "DMXSource"))
        return static_cast< DMXSource*>(const_cast< Scene*>(this));
